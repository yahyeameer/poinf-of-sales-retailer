...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "focus:outline-none focus:border-primary/60 focus:glow-md",
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "bg-popover text-popover-foreground glow-lg",
        // Popper-positioned, so the enter animation must not carry a translate
        // of its own — plain `scale-in`, not the dialog pair.
    ...
    >
      ...
      <SelectPrimitive.Viewport
        className={cn(
          "p-1",
          // Without this the dropdown can render narrower than its trigger,
          // which looks like a rendering bug rather than a menu.
